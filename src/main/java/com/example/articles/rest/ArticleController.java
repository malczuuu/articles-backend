...
import com.example.articles.core.article.ArticleNotFoundException;
import com.example.articles.core.article.ArticleService;
import com.example.articles.core.context.HeaderContext;
import com.example.articles.core.context.HeaderContextService;
import com.example.articles.model.ArticleCreateModel;
import com.example.articles.model.ArticleModel;
import com.example.articles.model.ArticleUpdateModel;
...
public class ArticleController {
  ...
  @PostMapping(
      ...
      produces = {MediaType.APPLICATION_JSON_VALUE})
  public ArticleModel createNote( @RequestHeader HttpHeaders headers, @RequestBody ArticleCreateModel requestBody) {
    HeaderContext context = headerContextService.getContext(headers);
